...
void inicio(void) {
    ...
    lcdCommand(0x80);
    lcdString("    ");
    lcdChar((((bcd2dec(dsReadData(4)& 0x5f)) / 10) % 10) + 48);
    lcdChar(((bcd2dec(dsReadData(4)& 0x5f)) % 10) + 48);
    lcdChar('/');
    lcdChar((((bcd2dec(dsReadData(5)& 0x3f)) / 10) % 10) + 48);
    lcdChar(((bcd2dec(dsReadData(5)& 0x3f)) % 10) + 48);
    lcdChar('/');
    lcdChar((((bcd2dec(dsReadData(6)& 0xff)) / 10) % 10) + 48);
    lcdChar(((bcd2dec(dsReadData(6)& 0xff)) % 10) + 48);
